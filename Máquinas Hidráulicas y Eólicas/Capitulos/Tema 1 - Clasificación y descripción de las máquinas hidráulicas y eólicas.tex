...
\begin{itemize}
    ...
    \begin{itemize}
        \item Motoras: La máquina absorbe energía del fluido para convertirla en energía mecánica en un eje, e.g. turbinas
...
Las bombas y ventiladores son Turbomáquinas, Hidráulicas, Generadoras. Su funcionamiento se basa en la Ecuación de Euler de las Turbomáquinas. Estudiamos las turbobombas o bombas rotodinámicas de mayor uso:
\begin{itemize}
