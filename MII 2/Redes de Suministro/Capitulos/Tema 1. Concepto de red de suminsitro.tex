...
\paragraph{Concepto de \textit{lead time}:}
es el tiempo entre el inicio y la finalización de un proceso (en particular, un proceso de producción).
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.5 \textwidth]{Imagenes/Tema 1. To order to stock (1).png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width = 0.5 \textwidth]{Imagenes/Tema 1. To order to stock (2).png}
\end{figure}
