...
$NOF = Caja + Clientes + Existencias - Proveedores - Otros Pasivos Espontaneos$
\subsection{Las Necesidades Operativas de Fondos}
Las NOF son las inversiones entas necearias en las operaciones corrientes que realiza la empresa. Las NOF constituyen, por lo tanto, un concepto de activo. Es decir, son una inversión. Para calcularlas es necesario conocer el periodo medio de maduración de la empresa.

Periodo medio de maduración de la empresa es el tiempo que transcurre entre el pago a los proveedores por la compra de existencias (materias primas, productos, etc.) y el cobro de las ventas a los clientes.

Número de días que tienen que transcurrir para recuperar una unidad monetaria invertida en el ciclo operativo de la empresa.

\subsection{El Fondo de Maniobra}

El fondo de maniobra es el exceso de los fondos sobre el inmovilizado para financiar las operaciones.

$Fondo De Maniobra = Financiacion Basica - Activo Fijo$

\subsubsection{$FM > 0$}
\begin{enumerate}
    \item Parte del activo circulante está financiado con pasivos circulantes, pero el resto del activo circulante está financiado con capitales permanentes.
    \item El activo fijo o inmovilizado está financiado íntegramente con recursos financieros de carácter permanente.
\end{enumerate}

\subsubsection{$FM = 0$}
\begin{enumerate}
    \item Todo el activo circulante está financiado con recursos a corto plazo (pasivo circulante)
    \item Todo el activo fijo o inmovilizado está financiado con recursos financieros de carácter permanente.
\end{enumerate}

\subsubsection{$FM < 0$}
\begin{enumerate}
    \item Todo el activo circulante está financiado con recursos a corto plazo (pasivo circulante).
    \item Hay parte del activo fijo o inmovilizdo que está financiado con recursos a corto plazo (pasivo circulante) y el resto del activo fijo o inmovilizado está financiado con recursos financieros de carácter permanente.
\end{enumerate}

\subsection{Necesidades de Fondos}
Dos perspectivas:
\begin{itemize}
    \item Planteamiento a largo plazo: Recursos necesarios para invertir en el inmovilizado productivo.
    \item Funcionamiento del día a día: Recursos necesarios para atender las obligaciones de las operaciones corrientes.
\end{itemize}

Dos consecuencias:
\begin{itemize}
    \item Empresa con problemas de planteamiento: Viable viento en popa, pero en cuanto llega una crisis entra en pérdidas se descapitaliza y se endeuda a precio alto, generando más pérdidas hasta una situación insostenible.
    \item Empresa con problemas de funcionamiento: Problemas de liquidez por una deficiente dirección de las finanzas operativas.
\end{itemize}
...
Si crece la empresa, crecen las NOF y habría que ver que fondos se sostiene dicho crecimiento:
\begin{itemize}
    \item Incremento del FM (Retención de beneficios o aportación de capital)
    \item Incremento de recursos bancarios negociados
\end{itemize}